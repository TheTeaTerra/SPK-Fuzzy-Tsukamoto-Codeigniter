			...
			<div class="table-responsive">
				<table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
					<thead class="alert-success">
						<tr>
							<th>No</th>
							<th>permintaan <br> (kubik)</th>
							<th>produksi <br> (kubik)</th>
							<th>penjualan <br> (kubik)</th>
							<th>Aksi</th>
						</tr>
					</thead>
					<tbody>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form
					...
					<div class="form-group">
						<label for="produksi_uji">Produksi*</label>
						<input
							class="form-control <?php echo form_error('produksi_uji') ? 'is-invalid':'' ?>"
							type="number" name="produksi_uji" placeholder="produksi_uji"
							value="<?php echo $p->produksi_uji ?>" />
						<div class="invalid-feedback">
							<?php echo form_error('produksi_uji') ?>
						</div>
					</div>
