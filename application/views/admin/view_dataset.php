			...
			<div class="modal-body">
				<form
					...
					<div class="form-group">
						...
						<input
							class="form-control <?php echo form_error('produksi') ? 'is-invalid':'' ?>"
							type="number" name="produksi" />
						<div class="invalid-feedback">
					...
					<div class="form-group">
						...
						<input
							...
							type="number" name="persediaan"></input>
						<div class="invalid-feedback">
			...
			<div class="modal-body">
				<form
					...
					<div class="form-group">
						...
						<input
							class="form-control <?php echo form_error('produksi') ? 'is-invalid':'' ?>"
							type="number" name="produksi" placeholder="produksi"
							value="<?php echo $p->produksi ?>" />
						<div class="invalid-feedback">
							<?php echo form_error('produksi') ?>
						</div>
					</div>
